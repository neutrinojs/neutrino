...
| `imagemin` | Optimize any images added by other webpack plugins (e.g. `copy-webpack-plugin`). | `NODE_ENV production` |
| `style-minify` | Minifies styles using `OptimizeCssAssetsPlugin`. | `NODE_ENV production` |
