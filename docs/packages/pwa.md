...
![](https://img.shields.io/npm/v/@neutrinojs/pwa.svg) ![](https://img.shields.io/npm/dt/@neutrinojs/pwa.svg)
...
The options passed to the PWA middleware are options accepted by [OfflinePlugin](https://github.com/NekR/offline-plugin). These are merged with the default values supplied by the PWA middleware using a deep object merge.
