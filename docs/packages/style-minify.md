...
`@neutrinojs/style-minify` is Neutrino middleware for minifying styles using [`OptimizeCssAssetsPlugin`](https://www.npmjs.com/package/optimize-css-assets-webpack-plugin). This middleware is usually only added during production builds.

![](https://img.shields.io/npm/v/@neutrinojs/style-minify.svg) ![](https://img.shields.io/npm/dt/@neutrinojs/style-minify.svg)
